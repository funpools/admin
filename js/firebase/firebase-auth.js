        ...
        function() {
          ...
          function c(t) {
            ...
            return s.prototype.o = function(t) {
              ...
              return new s(function(t, e) {
                for (var n = c(r), i = n.next(); !i.done; i = n.next()) u(i.value).La(t, e)
              })
            }, s.all = function(t) {
              var o = c(t),
                a = o.next();
              return a.done ? u([]) : new s(function(n, t) {
                ...
                for (var i = [], r = 0; i.push(void 0), r++, u(a.value).La(e(i.length - 1), t), !(a = o.next()).done;);
              })
            }, s
          });
          var u = u || {},
          ...
          function k(t, o) {
            function e() {}
            e.prototype = o.prototype, t.qb = o.prototype, t.prototype = new e, (t.prototype.constructor = t).gd = function(t, e, n) {
          ...
          ce.prototype.va = !(ue.prototype.name = "cancel"), ce.prototype.za = function() {
            if (this.la)
          ...
          function De(t, e) {
            if (Ce.call(this, t ? t.type : ""), this.relatedTarget = this.b = this.target = null, this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0, this.key = "", this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1, this.pointerId = 0, this.pointerType = "", this.a = null, t) {
          ...
          function je(t, e, n, i, r) {
            this.listener = t, this.proxy = null, this.src = e, this.type = n, this.capture = !!i, this.Pa = r, this.key = ++Me, this.ta = this.Ka = !1
          }

          function Ue(t) {
            t.ta = !0, t.listener = null, t.proxy = null, t.src = null, t.Pa = null
          }
          ...
          function Ke(t, e, n, i) {
            for (var r = 0; r < t.length; ++r) {
              var o = t[r];
              if (!o.ta && o.listener == e && o.capture == !!n && o.Pa == i) return r
            }
            return -1
          }
          Ve.prototype.add = function(t, e, n, i, r) {
            ...
            var a = Ke(t, e, i, r);
            return -1 < a ? (e = t[a], n || (e.Ka = !1)) : ((e = new je(e, this.src, o, !!i, r)).Ka = n, t.push(e)), e
          };
          ...
          function ze(t, e, n, i) {
            ...
            if ((t = Qe(t)) && (e = t.a[e.toString()]))
              for (e = e.concat(), t = 0; t < e.length; t++) {
                var o = e[t];
                o && o.capture == n && !o.ta && (o = $e(o, i), r = r && !1 !== o)
              }
            return r
          }
          ...
          function nn() {
            ce.call(this), this.u = new Ve(this), (this.Sb = this).Xa = null
          }
          ...
          function bn(t, e, n) {
            e instanceof Rn ? (t.a = e, function(t, e) {
              e && !t.f && (Cn(t), t.c = null, t.a.forEach(function(t, e) {
                var n = e.toLowerCase();
          ...
          function Ln(t, e) {
            Cn(t), e = Un(t, e), dn(t.a.b, e) && (t.c = null, t.b -= t.a.get(e).length, dn((t = t.a).b, e) && (delete t.b[e], t.c--, t.a.length > 2 * t.c && fn(t)))
          }
          ...
          function Un(t, e) {
            ...
            Cn(this), this.a.forEach(function(t, e) {
              M(t, function(t) {
                n.call(i, t, e, this)
              }, this)
            }, this)
            ...
            return Cn(this), this.c = null, xn(this, t = Un(this, t)) && (this.b -= this.a.get(t).length), this.a.set(t, [e]), this.b += 1, this
          }, t.get = function(t, e) {
          ...
          function oi(t) {
            return t = t || vi(), !("file:" !== wi() && "ionic:" !== wi() || !t.toLowerCase().match(/iphone|ipad|ipod|android/))
          }
          ...
          function zr(t, e) {
            this.Fc = e || [], ji(this, {
              providerId: t,
              isOAuthProvider: !0
            }), this.zb = {}, this.eb = (Rr(t) || {}).Ea || null, this.bb = null
          }
          ...
          function fo(t) {
            if (!(t.Va && t.Ua || t.Ha && t.ba)) throw new Yi("internal-error");
          ...
          k(Mr, xr), k(jr, Mr), k(Ur, Mr), k(Vr, Mr), k(Fr, Mr), Br.prototype.na = function(t) {
          ...
          }, k($r, zr), k(Zr, zr), Zr.prototype.ya = function(t) {
            ...
            return this.a.Va && (t.verificationId = this.a.Va), this.a.Ua && (t.verificationCode = this.a.Ua), this.a.Ha && (t.temporaryProof = this.a.Ha), this.a.ba && (t.phoneNumber = this.a.ba), t
          ...
          }, Eo = new Po, k(Co, Oo), Co.prototype.a = function() {
          ...
          function zo(t) {
            t.c.read().then(t.ec.bind(t)).catch(t.Oa.bind(t))
          }
          ...
          function Qo(t) {
            ...
            t && (e.body = t), this.o.fetch(new Request(this.g, e)).then(this.jc.bind(this), this.Oa.bind(this))
          }, t.abort = function() {
          ...
          function ia(e, t, n, i, r) {
            ...
            try {
              ...
              }(e.a), Wo(e.b, fa(e, "Will abort after " + e.g + "ms if incomplete, xhr2 " + e.v)), e.v ? (e.a.timeout = e.g, e.a.ontimeout = I(e.Ia, e)) : e.o = sn(e.Ia, e.g, e)), Wo(e.b, fa(e, "Sending request")), e.i = !0, e.a.send(t), e.i = !1
            } catch (t) {
          ...
          function Ia(t) {
            ...
            this.a && (this.c && (this.c = !1, this.f = !0, this.a.abort(), this.f = !1), ua(this, !0)), Qo.qb.za.call(this)
          }, t.Lb = function() {
          ...
          function Ea(t) {
            ...
            return e = window.setTimeout(function() {
                ...
                va(a), pa(a, !1, t)
              }, 5e3), o.Ia = e, r.onload = r.onreadystatechange = function() {
          ...
          xs.prototype.toString = function() {
            ...
            if (yn(t, "apiKey", this.m), yn(t, "appName", this.c), yn(t, "authType", this.u), this.a.isOAuthProvider) {
              ...
              for (var i in e.bb = n, yn(t, "providerId", this.a.providerId), n = Ei((e = this.a).zb)) n[i] = n[i].toString();
              i = e.Fc, n = W(n);
              for (var r = 0; r < i.length; r++) {
                var o = i[r];
                o in n && delete n[o]
              }
              e.eb && e.bb && !n[e.eb] && (n[e.eb] = e.bb), G(n) || yn(t, "customParameters", Ti(n))
            }
            ...
            if (t && t.f) {
              ...
              if (null == e)
                for (var n in this.a) {
                  ...
                  var o = this;
                  n = function() {
                    void 0 === t.a.a && o.b[e] === l.localStorage.getItem(e) || (o.b[e] = l.localStorage.getItem(e), o.$a(e))
          ...
          function Bu(t, e, n, i, r) {
            this.u = t, this.i = e, this.l = n, this.m = i || null, this.o = r || null, this.h = e + ":" + n, this.v = new Cu, this.g = new _u(this.h), this.f = null, this.b = [], this.a = this.c = null
          }
          ...
          function zu(t) {
            ...
            return this.Da ? this.Da : this.Da = (oi(void 0) ? ri().then(function() {
              return new qt(function(t, e) {
                var n = l.document,
            ...
            return this.c = Yt().then(function() {
              ...
              u && o.removeEventListener("resume", u, !1), c && o.removeEventListener("visibilitychange", c, !1), a && a.cancel(), s && r.Na(s), r.c = null
            })
          }, t.Aa = function(e) {
          ...
          Qu.prototype.reset = function() {
            this.f = !1, this.a.Na(this.l), this.a = tc(this.B, this.u, this.m), this.i = {}
          ...
          function Oc(e, t) {
            return function(t, i) {
              return new qt(function(e, n) {
                ...
                }, "POST", Dn(i).toString(), t.g, t.u.get()) : n(new Yi("internal-error"))
              })
          ...
          function Cc(t, e, n) {
            this.I = [], this.l = t.apiKey, this.m = t.appName, this.o = t.authDomain || null, t = fl.SDK_VERSION ? pi(fl.SDK_VERSION) : null, this.a = new Pa(this.l, Nr(Ar), t), this.b = new Ac(this.a), Vc(this, e[Ca]), Sc(this.b, e), Mi(this, "refreshToken", this.b.a), qc(this, n || {}), nn.call(this), this.J = !1, this.o && bi() && (this.i = fc(this.o, this.l, this.m)), this.O = [], this.h = null, this.w = function(e) {
            ...
            }(this), this.W = I(this.Ja, this);
            var i = this;
            this.ga = null, this.xa = function(t) {
              i.ua(t.g)
            }, this.Z = null, this.P = [], this.wa = function(t) {
              Lc(i, t.c)
            }, this.Y = null
          }

          function Dc(t, e) {
            t.Z && Xe(t.Z, "languageCodeChanged", t.xa), (t.Z = e) && Be(e, "languageCodeChanged", t.xa)
          }
          ...
          function xc(t, e) {
            t.Y && Xe(t.Y, "frameworkChanged", t.wa), (t.Y = e) && Be(e, "frameworkChanged", t.wa)
          }
          ...
          function $c(t, e) {
            e[Ca] && t.ma != e[Ca] && (Sc(t.b, e), t.dispatchEvent(new Rc("tokenChanged")), Vc(t, e[Ca]), Jc(t, "refreshToken", t.b.a))
          }
          ...
          function oh(t) {
            ...
            n[Ca] = t.stsTokenManager.accessToken, n.refreshToken = t.stsTokenManager.refreshToken || null, n.expiresIn = (t.stsTokenManager.expirationTime - E()) / 1e3;
            var i = new Cc(e, n, t);
          ...
          dc.prototype.reset = function() {
            ...
            if (t) {
              ...
              this.i = !(!r && !o), "unknown" != n || r || o ? t.a ? (gc(this, !0, null, t.a), Yt()) : e.Ba(n, i) ? function(e, t, n) {
                n = n.Ba(t.c, t.b);
                var i = t.g,
                  r = t.f,
                  o = t.i,
            ...
            if (t) {
              var n = t.c,
                i = t.b;
              t.a ? (e.ja(t.c, null, t.a, t.b), Yt()) : e.Ba(n, i) ? function(t, e) {
                var n = t.b,
                  i = t.c;
                e.Ba(i, n)(t.g, t.f, t.R(), t.i).then(function(t) {
                  e.ja(i, t, null, n)
                }).s(function(t) {
                  e.ja(i, null, t, n)
                })
          ...
          }, k(Rc, Ce), k(Cc, nn), Cc.prototype.ua = function(t) {
          ...
          }, Mi(Cc.prototype, "providerId", "firebase"), (t = Cc.prototype).reload = function() {
            var t = this;
            ...
            return rh(this, this.G().then(function(t) {
              ...
              Dc(e, null), xc(e, null), e.I = [], e.B = !0, Uc(e), Mi(e, "refreshToken", null), e.i && rc(e.i, e)
            })
          }, t.xb = function(t, e) {
          ...
          function gh(t) {
            ...
            t = fl.SDK_VERSION ? pi(fl.SDK_VERSION) : null, this.b = new Pa(Ah(this).options && Ah(this).options.apiKey, Nr(Ar), t), this.O = [], this.m = [], this.J = [], this.Ub = fl.INTERNAL.createSubscribe(I(this.oc, this)), this.W = void 0, this.Vb = fl.INTERNAL.createSubscribe(I(this.pc, this)), Eh(this, null), this.h = new ch(Ah(this).options.apiKey + ":" + Ah(this).name), this.w = new ah(Ah(this).options.apiKey + ":" + Ah(this).name), this.Y = _h(this, function(n) {
              ...
              }(this)), this.ga = !1, this.ma = I(this.Nc, this), this.ub = I(this.aa, this), this.wa = I(this.bc, this), this.xa = I(this.mc, this), this.Ja = I(this.nc, this), this.a = null,
              function(e) {
                ...
                n && bi() && (e.Tb = e.Y.then(function() {
                  if (!e.l) {
                    if (e.a = fc(n, i, Ah(e).name), ic(e.a, e), Sh(e) && Kc(Sh(e)), e.B) {
                      Kc(e.B);
                      var t = e.B;
                      t.ua(e.ha()), Dc(t, e), Lc(t = e.B, e.I), xc(t, e), e.B = null
                    }
                    return e.a
                  }
                }))
          ...
          function Eh(t, e) {
            ...
            }(Sh(t), t.ub), Xe(Sh(t), "tokenChanged", t.wa), Xe(Sh(t), "userDeleted", t.xa), Xe(Sh(t), "userInvalidated", t.Ja), Uc(Sh(t))), e && (e.O.push(t.ub), Be(e, "tokenChanged", t.wa), Be(e, "userDeleted", t.xa), Be(e, "userInvalidated", t.Ja), 0 < t.o && jc(e)), Mi(t, "currentUser", e), e && (e.ua(t.ha()), Dc(e, t), Lc(e, t.I), xc(e, t))
          }
          ...
          ch.prototype.mb = function(e) {
          ...
          }, k(gh, nn), k(bh, Ce), k(yh, Ce), (t = gh.prototype).mb = function(t) {
            ...
            var t = l.navigator;
            this.ua(t && (t.languages && t.languages[0] || t.language || t.userLanguage) || null)
          }, t.vc = function(t) {
            ...
            var i = function(t, e, n, i) {
              ...
              var r = t.b,
                o = {};
              return o[Ca] = r.b, o.refreshToken = r.a, o.expiresIn = (r.c - E()) / 1e3, e = new Cc(e, o), n && (e.da = n), i && Lc(e, i), Yc(e, t), e
            }(t, n, e.w, e.Ca());
            ...
            return Li("firebase.auth.Auth.prototype.signInAndRetrieveDataWithCredential is deprecated. Please use firebase.auth.Auth.prototype.signInWithCredential instead."), this.Sa(t)
          }, t.ob = function() {
            var n = this;
            return this.i.then(function() {
              var t = Sh(n);
            ...
            return _h(this, this.b.ab(t, e).then(function() {}))
          }, t.Ma = function(t) {
            return _h(this, this.b.Ma(t).then(function(t) {
              return new Fi(t)
            }))
          }, t.Ya = function(t) {
            return _h(this, this.b.Ya(t).then(function() {}))
          }, t.kb = function(e, t) {
            var n = this;
            return _h(this, Yt().then(function() {
          ...
          function Zh(t, e, n, i) {
            ...
            zh(this);
            var n = this;
            return Yh(this, this.Da().then(function() {
              if (null === n.c) {
                var t = n.u;
                if (!n.i) {
                  var e = Fn(t);
          ...
          ul(gh.prototype, {
              ...
              lc: {
                name: "languageCode",
                Za: sl(tl(), rl(), "languageCode")
              },
              ti: {
                name: "tenantId",
                Za: sl(tl(), rl(), "tenantId")
              }
            }), (gh.Persistence = Tu).LOCAL = "local", gh.Persistence.SESSION = "session", gh.Persistence.NONE = "none", ul(Cc.prototype, {
              delete: {
                name: "delete",
                j: []
              },
            ...
            function() {
              if (void 0 === fl || !fl.INTERNAL || !fl.INTERNAL.registerComponent) throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library.");
              var t = {
                ActionCodeInfo: {
                  Operation: {
                    EMAIL_SIGNIN: Ki,
              ...
              hl(t, "EmailAuthProvider", co, []), hl(t, "FacebookAuthProvider", Qr, []), hl(t, "GithubAuthProvider", eo, []), hl(t, "GoogleAuthProvider", io, []), hl(t, "TwitterAuthProvider", oo, []), hl(t, "OAuthProvider", Zr, [tl("providerId")]), hl(t, "SAMLAuthProvider", $r, [tl("providerId")]), hl(t, "PhoneAuthProvider", mo, [{
              ...
              }]), hl(t, "ActionCodeURL", Qi, []), fl.INTERNAL.registerComponent({
                name: "auth",
                ...
                instantiationMode: "LAZY",
                type: "PRIVATE"
              }), fl.registerVersion("@firebase/auth", "0.13.3"), fl.INTERNAL.extendNamespace({
                User: Cc
              })
            }()
